...
export class CustomerService {
  ...
  getCustomers(): Observable<ListResponseModel<Customer>> {
    ...
    return this.httpClient.get<ListResponseModel<Customer>>(this.apiUrl + extension);
  }

  getCustomerByMail(email: string): Observable<SingleResponseModel<Customer>> {
    const extension = 'customers/getByMail?email=';
    return this.httpClient.get<SingleResponseModel<Customer>>(this.apiUrl + extension + email);
  }
  ...
  updateCustomer(customer: Customer): Observable<ResponseModel> {
    ...
    return this.httpClient.post<ResponseModel>(this.apiUrl + extension, customer);
  }
