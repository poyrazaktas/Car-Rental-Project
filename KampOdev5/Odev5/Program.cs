...
using Odev5.Business.Concrete;
using Odev5.Business.Concrete.Platforms;
using Odev5.Business.Concrete.Sales;
using Odev5.Business.ValidationRules.Abstract;
using Odev5.Business.ValidationRules.Concrete.Mernis;
using Odev5.DataAccess.Abstract;
using Odev5.DataAccess.Concrete.Database;
using Odev5.DataAccess.Concrete.File;
using Odev5.Entities;
using Odev5.Entities.Concrete;
using System;
